...
class AssetStore:
    ...
    def _create_indexes(self):
        self.db.assets.create_index(
            [("customer_id", ASCENDING), ("asset_id", ASCENDING)], unique=True
        )
        self.db.assets.create_index([("customer_id", ASCENDING), ("_last_modified", DESCENDING)])
        self.db.assets.create_index(
            [("customer_id", ASCENDING), ("type", ASCENDING), ("status", ASCENDING)]
        )
    ...
    def get_asset(self, asset_id: str) -> dict:
        return self.db.assets.find_one(
            {"asset_id": asset_id, "customer_id": settings.customer_id},
